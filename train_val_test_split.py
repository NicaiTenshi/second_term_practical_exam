...
image_path = '/content/gdrive/MyDrive/datasets/cards/images/all'
train_path = '/content/gdrive/MyDrive/datasets/cards/images/train'
val_path = '/content/gdrive/MyDrive/datasets/cards/images/validation'
test_path = '/content/gdrive/MyDrive/datasets/cards/images/test'
